{{--
    ...
    Usage: @include('partials.avatar', ['avatar' => $user->avatar, 'size' => 40])
    $avatar : string — one of male_1, male_2, male_3, female_1, female_2, female_3
    $size   : int    — pixel width/height of the rendered SVG (default 40)
--}}
@php $size = $size ?? 40; @endphp

@switch($avatar ?? 'male_1')
    ...
    <svg width="{{ $size }}" height="{{ $size }}" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M39.5 30.5 L40.5 29.5 M42 30 L42 29 M44.5 30.5 L43.5 29.5" stroke="#1A0A04" stroke-width="0.8"/>
        <circle cx="31" cy="32.5" r="0.5" fill="white"/>
        <circle cx="43" cy="32.5" r="0.5" fill="white"/>
