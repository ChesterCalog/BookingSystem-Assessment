...
<body class="bg-[#FAF9F5] text-stone-800 antialiased min-h-screen flex flex-col">
    ...
    <nav class="bg-white border-b border-stone-200 px-6 py-4 flex justify-between items-center shadow-sm">
        ...
        <a href="<?php echo e(route('home')); ?>" class="text-xs font-bold tracking-widest uppercase text-stone-500 hover:text-stone-900 transition">
            ← Cancel & Return
        </a>
    </nav>
            ...
            <form action="#" method="POST" class="space-y-8">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="bg-amber-50 border border-amber-100 rounded-xl p-5 flex items-center space-x-4">
                        ...
                        <div>
                            <p class="text-sm font-bold text-stone-900">Booking as <?php echo e(auth()->user()->name); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div>
                    ...
                    <option value="<?php echo e(data_get($room, 'id')); ?>">
                        <?php echo e(data_get($room, 'name', 'Unnamed Room')); ?> - $<?php echo e(number_format(data_get($room, 'base_price', 0), 2)); ?>/night
    </option>
...
</html><?php /**PATH C:\Users\Licensed User\Documents\GitHub\BookingSystem-Assessment\hotel-booking\resources\views/booking/create.blade.php ENDPATH**/ ?>