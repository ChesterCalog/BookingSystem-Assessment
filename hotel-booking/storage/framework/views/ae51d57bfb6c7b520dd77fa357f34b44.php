        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-5 bg-white p-8 rounded-3xl border border-stone-200 shadow-xl space-y-6">
                ...
                <?php if(session('error')): ?>
                    <div class="bg-rose-50 border border-rose-200 p-4 rounded-xl text-rose-800 text-xs font-medium flex items-center space-x-2">
                        <span>⚠️</span> <span><?php echo e(session('error')); ?></span>
                    </div>
                <?php endif; ?>
                        ...
                        <div>
                            ...
                            <select id="room-selector" name="room_type_id" class="w-full p-3 border border-stone-200 bg-white rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-amber-600 transition cursor-pointer">
                                <?php $__currentLoopData = $roomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($room->id); ?>"><?php echo e($room->name); ?> ($<?php echo e(number_format($room->base_price, 2)); ?> / night)</option>
            ...
            <div class="lg:col-span-7 space-y-6">
                ...
                <div class="relative w-full">
                    <?php $__currentLoopData = $roomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div data-room-id="<?php echo e($room->id); ?>" class="room-card hidden bg-white rounded-3xl overflow-hidden shadow-md border border-stone-200 flex flex-col justify-between transition-all duration-300">
                            <div class="relative overflow-hidden aspect-[16/9] bg-stone-200">
                                <?php if($room->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $room->image)); ?>" alt="<?php echo e($room->name); ?>" class="w-full h-full object-cover">
                                <?php else: ?>
                                ...
                                <div class="absolute bottom-4 right-4 bg-stone-900 text-white px-4 py-2 rounded-xl text-sm font-bold shadow-lg">
                                    $<?php echo e(number_format($room->base_price, 2)); ?> / Night Allocation
                                </div>
                            </div>
                            ...
                            <div class="p-8 space-y-4 flex-grow flex flex-col justify-between">
                                <div class="space-y-2">
                                    ...
                                    <?php if($room->description): ?>
                                        <p class="text-sm text-stone-500 leading-relaxed font-light"><?php echo e($room->description); ?></p>
                                    <?php endif; ?>
                                </div>

                                <?php if($room->amenities): ?>
                                    <?php $amenities = is_array($room->amenities) ? $room->amenities : json_decode($room->amenities, true); ?>
                                    <div class="pt-4 border-t border-stone-100 grid grid-cols-2 gap-4 text-xs font-medium text-stone-500">
                                        <?php $__currentLoopData = $amenities ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="flex items-center space-x-2"><span>✨</span> <span><?php echo e($amenity); ?></span></span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
...
</html><?php /**PATH C:\Users\Licensed User\Documents\GitHub\BookingSystem-Assessment\hotel-booking\resources\views/reserve.blade.php ENDPATH**/ ?>