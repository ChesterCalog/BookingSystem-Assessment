...
<head>
    ...
    <title>Member Login | Grand Horizon Resort</title>
...
<body class="bg-[#FAF9F5] text-stone-800 antialiased min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 class="serif mt-2 text-center text-3xl font-bold tracking-tight text-stone-900">Member Access</h2>
        <p class="mt-2 text-center text-sm text-stone-500 font-light">
            Don't have an account?
            <a href="<?php echo e(route('register')); ?>" class="font-medium text-amber-700 hover:text-amber-800 transition">Join Membership</a>
        </p>
    </div>
        ...
        <div class="bg-white py-10 px-4 shadow-sm border border-stone-200/60 sm:rounded-3xl sm:px-10">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="password" name="password" type="password" required autocomplete="current-password" class="block w-full rounded-xl border-0 py-3 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-400 focus:ring-2 focus:ring-inset focus:ring-amber-800 sm:text-sm sm:leading-6 px-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <div class="text-sm">
                            <a href="<?php echo e(route('password.request')); ?>" class="font-medium text-amber-700 hover:text-amber-800 transition">Forgot password?</a>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="pt-4 text-center border-t border-stone-100">
                    <a href="<?php echo e(route('home')); ?>" class="text-xs text-stone-400 hover:text-stone-600 transition font-medium">← Return to Resort Homepage</a>
                </div>
            </form>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\Licensed User\Documents\GitHub\BookingSystem-Assessment\hotel-booking\resources\views/auth/login.blade.php ENDPATH**/ ?>